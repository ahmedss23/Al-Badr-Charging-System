                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="mid_name" type="text" class="form-control @error('mid_name') is-invalid @enderror" name="mid_name" value="{{ old('mid_name') }}" autocomplete="mid_name">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="profile_image" type="file" class="form-control @error('profile_image') is-invalid @enderror" name="profile_image" value="{{ old('profile_image') }}" required accept="image/png, image/gif, image/jpeg">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="drive_licence_image" type="file" class="form-control @error('drive_licence_image') is-invalid @enderror" name="drive_licence_image" value="{{ old('drive_licence_image') }}" accept="image/png, image/gif, image/jpeg">
